...
<html>
    <head>
        <title>Result - Tabulation System</title>
        ...
        <link rel="stylesheet" href="http://cdn2.editmysite.com/css/sites.css?buildTime=1389292999" type="text/css" />
        <link rel='stylesheet' type='text/css' href='http://cdn1.editmysite.com/editor/libraries/fancybox/fancybox.css?1389292999' />
    ...
    <body class='landing-page wsite-background  wsite-theme-dark wsite-page-results'>
        <div id="header-wrap">
            <div class="container">
                <div class="row">
        ...
        <div id="nav-wrap">
            <div class="container">
                <ul class='wsite-menu-default'>
                    <li id='pg912346048661492395'><a href='index.php'>Home</a></li>
                    <li id='pg847357659936707341'><a href='schedules.php'>Schedules</a></li>
                    <li id='active'><a href='results.php'>Results</a></li>
                    <li id='pg802070543251080871'><a href='popularity.php'>Popularity</a></li>
                    <li id='pg544485560115404534'><a href='about.php'>About</a></li>
                </ul>
            </div>
            <!-- end container -->
        </div>
        ...
        <div id="banner-wrap">
                    ...
                    <div class="row-fluid sortable ui-sortable">
                        <div class="box span6" style="">
                            <div class="box-header well">
                                <h2><i class="icon-star"></i> Cultural Overall Result</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                                </div>
                            </div>
                            <div class="box-content">
                                <?php include('cultural_total.php'); ?>
                            </div>
                        </div>
                        <!--/span-->
                        <div class="box span6">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="icon-star"></i> Sports Overall Result</h2>
                                <div class="box-icon">
                                    <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                                </div>
                            </div>
                            <div class="box-content">
                                <?php include('sport_total.php'); ?>
                            </div>
                        </div>
                        <!--/span-->
                    </div>
            ...
            <div id="main-wrap">
                ...
                <div id="content-bottom">
                    <p style="margin-left: 30%;">Copyright © 2014 Tabulation System.AllRight Reserved</p>
                </div>
            </div>
            <!-- end main-wrap -->
