        ...
        <div id="nav-wrap">
            <div class="container">
                <ul class='wsite-menu-default'>
                    ...
                    <li id='pg117404899752627942'><a href='results.php'>Results</a></li>
        ...
        <div id="banner-wrap">
            <div class="container">
                ...
                <div id="banner">
                    ...
                    <!--/end of 1st row-fluid sortable ui-sortable-->
                    <div class="row-fluid sortable ui-sortable">
                        <div class="box span4" style="">
                            ...
                            <div class="box-content">
                                <div>
                                    <p>Schedule of Cultural and Sport Events... <a href = "Schedules.php">Read More</a>
                                    <p>
                                    <p>Vote for Popularity here... <a href = "popularity.php">Read More</a>
                                    <p>
                                    <p>Show Who is leading the scoring in every Event... <a href = "results.php">Read More</a>	
                                    <p>
                                </div>
                            </div>
                        </div>
