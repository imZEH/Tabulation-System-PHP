...
<html>
    <head>
        <title>Schedule - Tabulation System</title>
        ...
        <div id="nav-wrap">
            <div class="container">
                <ul class='wsite-menu-default'>
                    ...
                    <li id='active'><a href='schedules.php'>Schedules</a></li>
                    ...
                    <div class="row-fluid sortable ui-sortable">
                        <div class="box span12" style="">
                            <div class="row-fluid sortable ui-sortable">
                                <div class="box span12" style="">
                                    <div class="box-header well">
                                        <h2><i class="icon-star"></i> Cultural Event Schedule</h2>
                                        <div class="box-icon">
                                            <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                                        </div>
                                    </div>
                                    <div class="box-content">
                                        <?php include('cultural_sched.php');?>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row-fluid sortable ui-sortable">
                                <div class="box span12" style="">
                                    <div class="box-header well">
                                        <h2><i class="icon-star"></i> Sport Event Schedule</h2>
                                        <div class="box-icon">
                                            <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                                        </div>
                                    </div>
                                    <div class="box-content">
                                        <?php include('sport_sched.php');?>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
