...
<html>
<head>
<title>About - Tabulation System</title>
...
<body class='landing-page wsite-background  wsite-theme-dark wsite-page-about'>
<div id="header-wrap">
    ...
    <div id="nav-wrap">
		<div class="container">
			<ul class='wsite-menu-default'><li id='pg912346048661492395'><a href='index.php'>Home</a></li><li id='pg847357659936707341'><a href='schedules.php'>Schedules</a></li><li id='pg117404899752627942'><a href='results.php'>Results</a></li><li id='pg802070543251080871'><a href='popularity.php'>Popularity</a></li><li id='active'><a href='about.php'>About</a></li></ul>
		</div><!-- end container -->
    </div><!-- end nav-wrap -->
        ...
        <div class="container">
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12" style="">
					...
					<div class="box-content">
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tabulation is a process of computing the result of an event and the presentation of tabular form. It also serves as an official document or record of a particular event. The processes, which are done manually, are implemented through the system. In which the project focuses on developing a software that would handle the tabulation of sports and cultural events.</p>
					</div>
				</div><!--/span-->
			...
			<div class="row-fluid sortable ui-sortable">
				...
				<div class="box span6" style="">
					<div class="box-header well">
						<h2><i class="icon-user"></i> Developer</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<center><img src="images/neil.jpg"   width="144" height="144"/>
						<p>Neil Ragadio - ngr_24@ymail.com</p>
						</center>
					</div>
				</div><!--/span-->
				...
				<div class="box span6">
					...
					<div class="box-content">
						<center><img src="images/ando.jpg"   width="144" height="144"/>
						<p>Ando Bellesco - andobellesco@yahoo.com</p>
						</center>
					</div>
				</div><!--/span-->
