...
<html>
    <head>
        <title>Popularity - Tabulation System</title>
    ...
    <body class='landing-page wsite-background  wsite-theme-dark wsite-page-popularity'>
        <div id="header-wrap">
            <div class="container">
                <div class="row">
        ...
        <div id="nav-wrap">
            <div class="container">
                <ul class='wsite-menu-default'>
                    ...
                    <li id='active'><a href='popularity.php'>Popularity</a></li>
                    ...
                    <div class="row-fluid sortable ui-sortable">
                        <div class="box span12">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="icon-user"></i> 2014 - Contestant</h2>
                                <div class="box-icon">
